# 🌡️ FIT5120 Heatwave Safety – Backend API
...
The backend is built with **Spring Boot**, exposes multiple REST APIs, and is deployed via **GitHub Actions + AWS Lambda API Gateway**.
